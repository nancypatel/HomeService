...
<body ng-app="myapp" class="skin-blue sidebar-mini" style="height: auto; min-height: 100%;">
  <!-- Site wrapper -->
  <div ng-controller="contactCtrl as c" class="wrapper" style="height: auto; min-height: 100%;">
            ...
            <table class="table table-striped table-hover" width="100%" border="0">
              <thead>
                <tr class="table_heading">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 88.45px;" aria-label="Salary: activate to sort column ascending">Subject</th>
                  <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 88.45px;" aria-label="Salary: activate to sort column ascending">Message</th>
                  <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 114.117px;" aria-label="Office: activate to sort column ascending">Edit</th>
              ...
              <tbody>
                <tr ng-repeat="x in Contact">
                  <th rowspan="1" colspan="1">{{x.cid}}</th>
                  <th rowspan="1" colspan="1">{{x.name}}</th>
                  <th rowspan="1" colspan="1">{{x.email}}</th>
                  <th rowspan="1" colspan="1">{{x.subject}}</th>
                  <th rowspan="1" colspan="1">{{x.message}}</th>
                  <th><a href="edit/{{x.cid}}" class="fa fa-edit" style="cursor: pointer; color:blue;"></a></th>
                  <th><a href="delete/{{x.cid}}" class="fa fa-trash" style="cursor: pointer; color: red;"></aD>
                  </th>
                </tr>
              </tbody>
            </table>
