            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <br>
                        <form action="<?php echo site_url('CategoryController/save')?>" method="post" enctype="multipart/form-data">
...
<!-- highlight_msg-->
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="form-control" name="highlight_msg"></textarea>
...
<!-- start why_msg-->
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="form-control " name="why_msg" ></textarea>
                                        </td>
                                    </tr>
<!-- End of why_msg-->
...
<!-- start of how_work-->
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="form-control" name="how_work"></textarea>
                                        </td>
                                    </tr>
<!-- End of how_work-->
